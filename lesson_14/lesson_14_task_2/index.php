        ...
        <div class="offset-md-2 w-50">
            ...
            <form class="row g-3" action="result.php" method="post">
                ...
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="text" name="userCity" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input name="gameCity" value="<?=$_SESSION['gameCity']; ?>" type="text" class="form-control" id="gameCity">
                </div>

                  <div class="mb-3">
                    <label for="gameCity">Результат игры</label>
                    <textarea name="gameCity" class="form-control" id="gameCity"><?php
                        if ($_SESSION['allGameCity']){echo$_SESSION['allGameCity'];}
